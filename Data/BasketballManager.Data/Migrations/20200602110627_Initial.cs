    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpponentTeams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OpponentTeams_MyTeams_MyTeamId",
                        column: x => x.MyTeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MyTeamId = table.Column<int>(nullable: false),
                    OpponentTeamId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_MyTeams_MyTeamId",
                        column: x => x.MyTeamId,
                        principalTable: "MyTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Games_OpponentTeams_OpponentTeamId",
                        column: x => x.OpponentTeamId,
                        principalTable: "OpponentTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OffenciveRebounds = table.Column<int>(nullable: false),
                    ...
                    ThreePointsAttempt = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameStatistics", x => new { x.GameId, x.StatisticId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameStatistics_Statistics_StatisticId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameStatistics_StatisticId",
                table: "GameStatistics",
                column: "StatisticId");

            migrationBuilder.CreateIndex(
                name: "IX_MyTeams_IsDeleted",
                table: "MyTeams",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpponentTeams_MyTeamId",
                table: "OpponentTeams",
                column: "MyTeamId");
